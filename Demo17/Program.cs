namespace Demo17
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            choices = 
                (Console.ReadKey().Key == ConsoleKey.O) ? 
                (CoffeeChoices)((int)choices + (int)CoffeeChoices.WithMilk) : choices;
            Console.WriteLine("Avec du sucre? (O)ui - (N)on");
            choices =
                (Console.ReadKey().Key == ConsoleKey.O) ?
                (CoffeeChoices)((int)choices + (int)CoffeeChoices.WithSugar) : choices;
            Console.WriteLine("Avec de la chantilly? (O)ui - (N)on");
            choices =
                (Console.ReadKey().Key == ConsoleKey.O) ?
                (CoffeeChoices)((int)choices + (int)CoffeeChoices.WithCream) : choices;
            Console.WriteLine("Avec du caramel? (O)ui - (N)on");
            choices =
                (Console.ReadKey().Key == ConsoleKey.O) ?
                (CoffeeChoices)((int)choices + (int)CoffeeChoices.WithCaramel) : choices;
            Console.WriteLine("Avec du cacao? (O)ui - (N)on");
            choices =
                (Console.ReadKey().Key == ConsoleKey.O) ?
                (CoffeeChoices)((int)choices + (int)CoffeeChoices.WithCocoa) : choices;
            ...
            {
                Console.WriteLine("J'ajoute de la chantilly.");
            }
